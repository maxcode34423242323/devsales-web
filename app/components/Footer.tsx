...
export default function Footer(){return <footer className="mix-footer"><motion.div {...reveal} className="footer-shell">
  ...
  <div className="footer-main"><div><Link className="footer-logo" href="/"><i>D</i><span>DEVILSALES</span></Link><p>Strategy, design and development for ambitious service businesses across the USA and Europe.</p></div><div><h3>Pages</h3><Link href="/">Home</Link><Link href="/#services">Services</Link><Link href="/work">Portfolio</Link><Link href="/contact">Contact</Link></div><div><h3>Contact</h3><a href="mailto:info@devilsales.dev">info@devilsales.dev</a><a href="tel:+393342070234">+39 334 207 0234</a><p>Italy · USA · Worldwide</p></div></div>
